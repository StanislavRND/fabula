        ...
        <div className="price__items">
          <div className="price__item">
            ...
            <div className="price__item-info">
              ...
              <button onClick={() => navigate('/service/1')} className="price__item-info-btn">Подробнее</button>
            </div>
          </div>
          <div className="price__item">
            ...
            <div className="price__item-info">
              ...
              <button onClick={() => navigate('/service/2')} className="price__item-info-btn">Подробнее</button>
            </div>
          </div>
          <div className="price__item">
            ...
            <div className="price__item-info">
              ...
              <button onClick={() => navigate('/service/3')} className="price__item-info-btn">Подробнее</button>
            </div>
          </div>
          <div className="price__item">
            ...
            <div className="price__item-info">
              ...
              <button onClick={() => navigate('/service/4')} className="price__item-info-btn">Подробнее</button>
            </div>
          </div>
          <div className="price__item">
            ...
            <div className="price__item-info">
              ...
              <div className="price__item-info-price">3 000 ₽</div>
              <button onClick={() => navigate('/service/5')} className="price__item-info-btn">Подробнее</button>
            </div>
          </div>
          <div className="price__item">
            ...
            <div className="price__item-info">
              ...
              <button onClick={() => navigate('/service/6')} className="price__item-info-btn">Подробнее</button>
            </div>
          </div>
          <div className="price__item">
            ...
            <div className="price__item-info">
              ...
              <button onClick={() => navigate('/service/7')} className="price__item-info-btn">Подробнее</button>
            </div>
          </div>
          <div className="price__item">
            ...
            <div className="price__item-info">
              ...
              <div className="price__item-info-price">20 000 ₽</div>
              <button onClick={() => navigate('/service/8')} className="price__item-info-btn">Подробнее</button>
            </div>
          </div>
        </div>
      </div>
