...
export const Footer = () => {
  return (
    <footer id="contacts" className="footer header">
      <div className="container">
        <div className="header__logo">
          <img src={logo} alt="" />
          Фабула
        </div>
        <div className="header__info footer__info">
          <div className="header__address footer__address">
            <a
              target="_blank"
          ...
          <div className="header__contacts footer__contacts">
